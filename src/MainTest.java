...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        // Désactivation du plein écran et définition d'une taille décente
        maFenetre.setSize(1200, 800); // Taille initiale de la fenêtre
        maFenetre.setLocationRelativeTo(null); // Centrer la fenêtre
        maFenetre.setResizable(true); // Permettre le redimensionnement
